                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <a href="<?php echo site_url('Pengaduan/edit_proses/terima/' .$pengaduan['id_pengaduan']) ?>" class="btn btn-success"><i class="fa fa-check"></i> Terima</a>
                                    <a href="<?php echo site_url('Pengaduan/edit_proses/tolak/' .$pengaduan['id_pengaduan']) ?>" class="btn btn-warning"><i class="gi gi-circle_remove"></i> Tolak</a>
                                    <a href="<?php echo site_url('Pengaduan/hapus/' .$pengaduan['id_pengaduan']) ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus?')" class="btn btn-danger"><i class="fa fa-trash-o"></i> Hapus</a>   
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
